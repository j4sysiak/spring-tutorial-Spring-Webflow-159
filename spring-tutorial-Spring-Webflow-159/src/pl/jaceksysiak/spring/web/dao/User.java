...
public class User implements Serializable {
	...
	@Size(min=2, max=15, groups={PersistenceValidationGroup.class, FormValidationGroup.class})
	@Pattern(regexp="^\\w{2,}$", groups={PersistenceValidationGroup.class, FormValidationGroup.class})
	@Id
	...
	@Size(min=2, max=15, groups={FormValidationGroup.class})
	...
	@NotBlank(groups={PersistenceValidationGroup.class, FormValidationGroup.class})
	@Size(min=2, max=100, groups={PersistenceValidationGroup.class, FormValidationGroup.class})
	private String name;
